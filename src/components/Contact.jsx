...
const socialLinks = [
  ...
  {
    href: "https://www.github.com/shahriar-tamjid",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  return (
    <section id="contact" className="section">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        ...
        <form
          action="https://getform.io/f/bolmemza"
          method="POST"
        ...
        >
          <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
            ...
            {/* <div className="mb-4">
                        ...
                        className='text-field resize-y min-h-32 max-h-80 w-full'></textarea>
                    </div> */}
            ...
            <div class="flex flex-col md:col-span-2">
              ...
              <textarea
                ...
                rows="5"
                required
                className="w-full px-3 py-3 text-sm bg-zinc-800 rounded-xl ring-1 ring-inset ring-transparent transition-shadow hover:ring-zinc-50/5 focus:ring-teal-400 reveal-up"
              ></textarea>
            </div>

            <button
              type="submit"
              className="btn btn-primary mt-3 [&]:max-w-full w-full justify-center reveal-up"
            >
              Submit
            </button>
          </div>
